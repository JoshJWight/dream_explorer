def main():
  ...
  #Custom reward that only cares about score, lives, and clears
  #Much more sparse than the original
  class MarioScoreReward(gym.Wrapper):
    ...
    def step(self, action):
      state, oldreward, done, info = self.env.step(action)
      reward = (info['score'] - self._current_score)
